  ...
  return (
    <div className="flex flex-col items-center">
      <div className="w-full max-w-[600px] px-8">
        <div className="max-w-[480px] backdrop-blur-2xl bg-black/40 border border-white/10 rounded-3xl p-10 shadow-[0_0_40px_-10px_rgba(0,0,0,0.5)]">
          <h2 className="text-white text-[31px] font-bold mb-8 text-center">Join today.</h2>
          
          <div className="space-y-3 mb-6">
            <Button
              type="button"
              className="w-full h-12 rounded-full bg-white text-black font-bold text-[15px] hover:bg-white/90 hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 flex items-center justify-center gap-2 shadow-lg"
            >
          ...
          <div className="mt-8 pt-6 border-t border-white/10">
            <p className="text-white text-[17px] font-bold mb-4">Already have an account?</p>
            <Link href="/login">
              <Button
                type="button"
                className="w-full h-12 rounded-full bg-transparent text-[#1d9bf0] font-bold text-[15px] border border-white/20 hover:bg-[#1d9bf0]/10 hover:border-[#1d9bf0]/50 transition-all duration-200"
              >
                Sign in
              </Button>
            </Link>
